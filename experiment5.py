    ...
    for con_count in [20]:
        for var_count in [75, 100, 125]:
            ...
            for model in instances:
                ...
                print("  A orthogonality:", du.orthogonality_measure_1(A, by_rows=True))
                ...
                AU_np = np.array(AU.tolist(), dtype=float)
                print("  AU orthogonality:", du.orthogonality_measure_1(AU_np, by_rows=True))
